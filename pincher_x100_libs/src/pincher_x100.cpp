...
#include "../include/pincher_x100_libs/pincher_x100.hpp"


PincherX100::PincherX100() {}
...
void PincherX100::init_pincher_x100(bool using_actual_robot_state, STRING usb_port, STRING baud_rate, float control_loop_time, std::vector<uint8_t> dxl_id)
{
  /*****************************************************************************
    ...
    *****************************************************************************/
    ...
    addJoint("shoulder_pitch_joint",  // my name
             ...
             +2.01,     // max joint limit (2.01 rad)
             -1.68,     // min joint limit (-1.68 rad)
             1.0,       // coefficient
             1.3850917e-01,                                                        // mass
    ...
    addJoint("elbow_pitch_joint",    // my name
             ...
             1.57,      // max joint limit (1.57 rad)
             -2.09,     // min joint limit (-2.09 rad)
             1.0,       // coefficient
             1.3274562e-01,                                                        // mass
    ...
    addJoint("wrist_pitch_joint",  // my name
             ...
             2.27,      // max joint limit (2.27 rad)
             -1.92,     // min joint limit (-1.92 rad)
             1.0,       // coefficient
             1.4327573e-01,                                                        // mass
...
void PincherX100::process_pincher_x100(double present_time)
{
