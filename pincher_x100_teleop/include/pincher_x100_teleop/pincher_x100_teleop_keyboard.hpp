...
#ifndef PINCHER_X100_TELEOP_KEYBOARD_HPP_
#define PINCHER_X100_TELEOP_KEYBOARD_HPP_
...
{
class PincherX100TeleopKeyboard : public rclcpp::Node
{
 public:
  PincherX100TeleopKeyboard();
  virtual ~PincherX100TeleopKeyboard();
...
#endif  // PINCHER_X100_TELEOP_KEYBOARD_HPP_
