...
#ifndef PINCHER_X100_TELEOP_JOYSTICK_HPP_
#define PINCHER_X100_TELEOP_JOYSTICK_HPP_
...
{
class PincherX100TeleopJoystick : public rclcpp::Node
{
 public:
  PincherX100TeleopJoystick();
  virtual ~PincherX100TeleopJoystick();
...
#endif  // PINCHER_X100_TELEOP_JOYSTICK_HPP_
