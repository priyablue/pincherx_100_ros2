...
#include "pincher_x100_teleop/pincher_x100_teleop_joystick.hpp"

using namespace std::placeholders;


namespace pincher_x100_teleop_joystick
{
PincherX100TeleopJoystick::PincherX100TeleopJoystick()
: Node("pincher_x100_teleop_joystick")
{
  /*****************************************************************************
  ...
  *****************************************************************************/
  ...
  joint_states_sub_ = this->create_subscription<sensor_msgs::msg::JointState>(
    "pincher_x100/joint_states", qos, std::bind(&PincherX100TeleopJoystick::joint_states_callback, this, _1));
  kinematics_pose_sub_ = this->create_subscription<open_manipulator_msgs::msg::KinematicsPose>(
    "pincher_x100/kinematics_pose", qos, std::bind(&PincherX100TeleopJoystick::kinematics_pose_callback, this, _1));
  joy_command_sub_ = this->create_subscription<sensor_msgs::msg::Joy>(
    "joy", qos, std::bind(&PincherX100TeleopJoystick::joy_callback, this, _1));

  /*****************************************************************************
  ** Initialise Clients
  *****************************************************************************/
  goal_joint_space_path_client_ = this->create_client<open_manipulator_msgs::srv::SetJointPosition>("pincher_x100/goal_joint_space_path");
  goal_tool_control_client_ = this->create_client<open_manipulator_msgs::srv::SetJointPosition>("pincher_x100/goal_tool_control");
  goal_task_space_path_from_present_position_only_client_ = this->create_client<open_manipulator_msgs::srv::SetKinematicsPose>("pincher_x100/goal_task_space_path_from_present_position_only");

  RCLCPP_INFO(this->get_logger(), "PincherX-100 Teleop Joystick Initialised");
}

PincherX100TeleopJoystick::~PincherX100TeleopJoystick() 
{
  RCLCPP_INFO(this->get_logger(), "PincherX-100 Teleop Joystick Terminated");
}

/*****************************************************************************
** Callback Functions
*****************************************************************************/
void PincherX100TeleopJoystick::joint_states_callback(const sensor_msgs::msg::JointState::SharedPtr msg)
{
...
void PincherX100TeleopJoystick::kinematics_pose_callback(const open_manipulator_msgs::msg::KinematicsPose::SharedPtr msg)
{
...
void PincherX100TeleopJoystick::joy_callback(const sensor_msgs::msg::Joy::SharedPtr msg)
{
...
*****************************************************************************/
void PincherX100TeleopJoystick::set_goal(const char * str)
{
...
bool PincherX100TeleopJoystick::set_joint_space_path(std::vector<std::string> joint_name, std::vector<double> joint_angle, double path_time)
{
...
bool PincherX100TeleopJoystick::set_tool_control(std::vector<double> joint_angle)
{
  auto request = std::make_shared<open_manipulator_msgs::srv::SetJointPosition::Request>();
...
bool PincherX100TeleopJoystick::set_task_space_path_from_present_position_only(std::vector<double> kinematics_pose, double path_time)
{
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::spin(std::make_shared<pincher_x100_teleop_joystick::PincherX100TeleopJoystick>());
  rclcpp::shutdown();
