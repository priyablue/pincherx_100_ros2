...
#include "pincher_x100_teleop/pincher_x100_teleop_keyboard.hpp"
...
namespace pincher_x100_teleop_keyboard
{
PincherX100TeleopKeyboard::PincherX100TeleopKeyboard()
: Node("pincher_x100_teleop_keyboard")
{
  /********************************************************************************
  ...
  ********************************************************************************/
  ...
  joint_states_sub_ = this->create_subscription<sensor_msgs::msg::JointState>(
    "pincher_x100/joint_states", qos, std::bind(&PincherX100TeleopKeyboard::joint_states_callback, this, _1));
  kinematics_pose_sub_ = this->create_subscription<open_manipulator_msgs::msg::KinematicsPose>(
    "pincher_x100/kinematics_pose", qos, std::bind(&PincherX100TeleopKeyboard::kinematics_pose_callback, this, _1));

  /********************************************************************************
  ** Initialise Clients
  ********************************************************************************/
  goal_joint_space_path_client_ = this->create_client<open_manipulator_msgs::srv::SetJointPosition>(
    "pincher_x100/goal_joint_space_path");
  goal_tool_control_client_ = this->create_client<open_manipulator_msgs::srv::SetJointPosition>(
    "pincher_x100/goal_tool_control");
  goal_task_space_path_from_present_position_only_client_ = this->create_client<open_manipulator_msgs::srv::SetKinematicsPose>(
    "pincher_x100/goal_task_space_path_from_present_position_only");
  goal_joint_space_path_from_present_client_ = this->create_client<open_manipulator_msgs::srv::SetJointPosition>(
    "pincher_x100/goal_joint_space_path_from_present");

  /********************************************************************************
  ** Display in terminal
  ********************************************************************************/
  this->disable_waiting_for_enter();
  update_timer_ = this->create_wall_timer(10ms, std::bind(&PincherX100TeleopKeyboard::update_callback, this));

  RCLCPP_INFO(this->get_logger(), "PincherX-100 Teleop Keyboard Initialised");
}

PincherX100TeleopKeyboard::~PincherX100TeleopKeyboard() 
{
  this->restore_terminal_settings();
  RCLCPP_INFO(this->get_logger(), "PincherX-100 Teleop Keyboard Terminated");
}

/********************************************************************************
** Callback Functions
********************************************************************************/
void PincherX100TeleopKeyboard::joint_states_callback(const sensor_msgs::msg::JointState::SharedPtr msg)
{
...
void PincherX100TeleopKeyboard::kinematics_pose_callback(const open_manipulator_msgs::msg::KinematicsPose::SharedPtr msg)
{
...
********************************************************************************/
void PincherX100TeleopKeyboard::set_goal(char ch)
{
...
bool PincherX100TeleopKeyboard::set_joint_space_path(std::vector<std::string> joint_name, std::vector<double> joint_angle, double path_time)
{
...
bool PincherX100TeleopKeyboard::set_tool_control(std::vector<double> joint_angle)
{
  auto request = std::make_shared<open_manipulator_msgs::srv::SetJointPosition::Request>();
...
bool PincherX100TeleopKeyboard::set_task_space_path_from_present_position_only(std::vector<double> kinematics_pose, double path_time)
{
...
bool PincherX100TeleopKeyboard::set_joint_space_path_from_present(std::vector<std::string> joint_name, std::vector<double> joint_angle, double path_time)
{
  auto request = std::make_shared<open_manipulator_msgs::srv::SetJointPosition::Request>();
  request->joint_position.joint_name = joint_name;
  request->joint_position.position = joint_angle;
...
** Other Functions
********************************************************************************/
void PincherX100TeleopKeyboard::print_text()
{
  system("clear");
  printf("\n");
  printf("-----------------------------\n");
  printf("Control Your Pincher Arm!\n");
  printf("-----------------------------\n");
...
std::vector<double> PincherX100TeleopKeyboard::get_present_joint_angle()
{
  return present_joint_angle_;
}

std::vector<double> PincherX100TeleopKeyboard::get_present_kinematics_pose()
{
  return present_kinematic_position_;
}

void PincherX100TeleopKeyboard::restore_terminal_settings()
{
  tcsetattr(0, TCSANOW, &oldt_);  /* Apply saved settings */
}

void PincherX100TeleopKeyboard::disable_waiting_for_enter()
{
  struct termios newt;
...
void PincherX100TeleopKeyboard::update_callback()  
{
  this->print_text();  
...
int main(int argc, char *argv[])
{
  ...
  rclcpp::spin(std::make_shared<pincher_x100_teleop_keyboard::PincherX100TeleopKeyboard>());
  rclcpp::shutdown();
